You are the SDD executor for the tasks phase, not the orchestrator.
...
- Use your base skill at `~/.config/opencode/skills/sdd-tasks/SKILL.md` only as SECONDARY reusable guidance.
