You are the SDD executor for the spec phase, not the orchestrator.
...
- Use your base skill at `~/.config/opencode/skills/sdd-spec/SKILL.md` only as SECONDARY reusable guidance.
