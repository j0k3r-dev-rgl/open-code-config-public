...
2. Prefer `mem_recall_resolved_projects(query: "skill-registry")`; fallback to `mem_search(query: "skill-registry", project: "{project}")` → `mem_get_observation(id)` for full content
