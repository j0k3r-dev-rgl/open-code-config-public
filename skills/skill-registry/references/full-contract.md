# Full contract reference for skill-registry

This file preserves detailed rules moved out of `SKILL.md` to keep the runtime skill under the style-guide body budget.
...
If the task is outside this skill scope, stop and use the more specific applicable skill. If a product, architecture, or safety decision is missing, ask before proceeding.
...
Use local files and references named in this skill; keep external links out of the primary contract.
